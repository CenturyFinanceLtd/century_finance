                                ...
                                <SwiperSlide key={idx.id}>
                                    <div className="slider-item">
                                            <div className="tf-slider-item style-3">
                                                    ...
                                                    <div className="text-typing">
                                                        ...
                                                        <div className="animate-contain">
                                                            <div className="animated-text">
                                                                <span>Century Finance Limited</span>
                                                                <span>Music</span>
                                                                <span>NFT</span>
                                                            </div>
                                                        </div>
                                                ...
                                                <div className="image">
                                                    <img src={img1} alt="Century Finance Limited" className="img ani5" />
                                                    <img src={img2} alt="Century Finance Limited" className="ani4 img-1" />
                                                    <img src={img3} alt="Century Finance Limited" className="ani5 img-2" />

  ...
  return (
    <div className="legal-page">
      ...
      <section className="legal-content tf-container">
        <div className="inner">
          <h2 style={{ textAlign: 'center', marginBottom: 20 }}>Terms and Conditions of Use for Century Finance Limited</h2>
          <p>
            <strong>Effective Date:</strong> May 23, 2025
          </p>
          <p style={{ fontSize: 15 }}>
            Welcome to Century Finance Limited. These Terms and Conditions ("Terms") govern your use of the
            Website and services provided by Century Finance Limited ("Company," "we," "our," or "us"). By
            accessing or using the Website, you acknowledge that you have read, understood, and agreed to be bound by
            these Terms. If you do not agree with these Terms, you must not use this Website or our services. READ
            THESE TERMS AND CONDITIONS ("TERMS") CAREFULLY BEFORE USING THE SERVICES
          </p>

          <div className="terms">
            <h3>1. Eligibility and General Use</h3>
            <p>
              1.1 You affirm that you are at least 18 years of age and legally capable of entering into binding
              contracts under applicable laws. The services provided on this Website are not intended for minors or
              individuals legally prohibited from engaging in financial contracts.
            </p>
            ...
            <p>
              For more details on Investor awareness, please visit
              <a href="https://www.nseindia.com/invest/investors-home" target="_blank" rel="noopener noreferrer"> www.nseindia.com/invest/investors-home</a>
            </p>
            <p>
              For more information related to investments in securities market, please visit SEBI Investor Website -
              <a href="https://investor.sebi.gov.in" target="_blank" rel="noopener noreferrer"> https://investor.sebi.gov.in</a> and SEBI Saa₹thi Mobile App.
            </p>
            ...
            <ul>
              <li>
                General enquiry - <a href="mailto:general-inquiry@centuryfinancelimited.com">general-inquiry@centuryfinancelimited.com</a>
              </li>
              <li>
                Customer Service - <a href="mailto:customerservice@centuryfinancelimited.com">customerservice@centuryfinancelimited.com</a>
              </li>
            </ul>
            <p>
              🌐 Website:
              <a href="https://centuryfinancelimited.com" target="_blank" rel="noopener noreferrer"> https://centuryfinancelimited.com</a>
            </p>

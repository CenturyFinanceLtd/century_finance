...
class NavbarMenu extends React.Component {
  ...
  render() {
    ...
    // Determine the display name from stored user info
    let displayName = "User";
    try {
      const stored = typeof window !== "undefined" ? localStorage.getItem("user") : null;
      if (stored) {
        const u = JSON.parse(stored);
        displayName = u?.name || u?.fullName || u?.email || displayName;
      }
    } catch (e) {
      // ignore JSON parse errors and keep default display name
    }
            ...
            <div className="navbar-right">
              ...
              <div id="navbar-menu">
                <ul className="nav navbar-nav">
                  ...
                  <li>
                  <a href="#!" className="icon-menu" onClick={this.handleLogout}>
            ...
            <div className="user-account">
              ...
              <Dropdown>
                ...
                <Dropdown.Menu className="dropdown-menu-right account">
                  ...
                  <Dropdown.Item href="#!" className="icon-menu" onClick={this.handleLogout}>
                    {" "}

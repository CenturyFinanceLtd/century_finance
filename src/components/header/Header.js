                                ...
                                <div id="navbar" className="collapse navbar-collapse navigation-holder">
                                    ...
                                    <ul className="nav navbar-nav mb-2 mb-lg-0">
                                        ...
                                        <li className="menu-item-has-children">
                                            ...
                                            <ul className="sub-menu">
                                                <li><Link onClick={ClickHandler} to="/course">Courses Style 1</Link></li>
                                                <li><Link onClick={ClickHandler} to="/course-2">Courses Style 2</Link></li>
                                                <li><Link onClick={ClickHandler} to="/course-3">Courses Style 3</Link></li>
                                                <li><Link onClick={ClickHandler} to="/course-single/Learn-WordPress-&-Elementor-for-Beginners">Courses single</Link></li>
                                            </ul>
                                        </li>
                                        <li className="menu-item-has-children">
